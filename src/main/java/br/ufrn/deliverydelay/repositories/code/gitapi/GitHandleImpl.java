package br.ufrn.deliverydelay.repositories.code.gitapi;
	...
	public List<GITLogEntry> findCommitsByTimeRangeAndDevelopers(Date startDate,
		...
		try {	
			...
			while ((line = br.readLine()) != null){
				...
				if(isCommitLine(line)){ // Is a commit information line
					...
					if (line.startsWith("Conflicts:") || line.startsWith("\t"))
						continue;
...
//		String emailRegexValidation = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$";
		String emailRegexValidation = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@.*";
	...
	public void teste() {
		String command = "git log --pretty=format:%H -- SIGRH/funcional/br/ufrn/sigrh/funcional/progressao/jsf/ProcessoSolicitacaoProgressaoMBean.java";
		
//		String[] command = new String[] { "git", "log", "--pretty=format:%H", "SIGRH/funcional/br/ufrn/sigrh/funcional/progressao/jsf/ProcessoSolicitacaoProgressaoMBean.java"};
		
//		String command = "git log --pretty=format:%H --follow";
//				+ "SIGRH/funcional/br/ufrn/sigrh/funcional/progressao/jsf/ProcessoSolicitacaoProgressaoMBean.java";
	...
	public static void main(String[] args) {
		new GitHandleImpl("git@gitdesenvolvimento.info.ufrn.br:dev/sigrh.git", "", "").teste();
	}
...
//		String[] command = new String[] { "git", "log", "--pretty=format:%H ", path};
